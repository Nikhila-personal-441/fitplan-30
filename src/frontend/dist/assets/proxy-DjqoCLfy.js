...
import { h as ProtocolError, T as TimeoutWaitingForResponseErrorCode, i as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, k as RequestStatusResponseStatus, U as UnknownError, m as RequestStatusDoneNoReplyErrorCode, n as RejectError, o as CertifiedRejectErrorCode, p as UNREACHABLE_ERROR, I as InputError, q as InvalidReadStateRequestErrorCode, s as ReadRequestType, t as Principal, v as IDL, w as MissingCanisterIdErrorCode, H as HttpAgent, x as encode, Q as QueryResponseStatus, y as UncertifiedRejectErrorCode, z as isV3ResponseBody, A as isV2ResponseBody, B as UncertifiedRejectUpdateErrorCode, D as UnexpectedErrorCode, F as decode, S as Subscribable, G as pendingThenable, J as resolveEnabled, K as shallowEqualObjects, L as resolveStaleTime, N as noop$1, O as environmentManager, V as isValidTimeout, W as timeUntilStale, X as timeoutManager, Y as focusManager, Z as fetchState, _ as replaceData, $ as notifyManager, a0 as hashKey, a1 as getDefaultState, r as reactExports, a2 as shouldThrowError, f as useQueryClient, a3 as useInternetIdentity, a4 as createActorWithConfig, a5 as clsx, j as jsxRuntimeExports, c as cn, a6 as Record, a7 as Variant, a8 as Vec, a9 as Opt, aa as Service, ab as Func, ac as Text, ad as Nat, ae as Null, af as Int, ag as Float64, ah as Principal$1, ai as Bool, aj as useRouterState, ak as Link } from "./index-BEzjik7-.js";
...
const appButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl font-display font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-[1.02] shadow-sm hover:shadow-md active:scale-[0.98]",
        hero: "bg-primary text-primary-foreground text-lg px-8 py-4 hover:bg-primary/90 hover:scale-[1.03] shadow-lg hover:shadow-xl active:scale-[0.97]",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/90 hover:scale-[1.02] shadow-sm active:scale-[0.98]",
        outline: "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground hover:scale-[1.02] active:scale-[0.98]",
        ghost: "text-foreground hover:bg-muted hover:scale-[1.01] active:scale-[0.99]",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:scale-[1.02] active:scale-[0.98]",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 hover:scale-[1.02] shadow-sm active:scale-[0.98]",
  ...
  ({ className, variant, size, loading, disabled, children, ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        ...props,
        children: [
          loading && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-1 h-4 w-4 animate-spin rounded-full border-2 border-current border-t-transparent" }),
          children
        ]
      }
    );
...
function useAuth() {
  const { identity, loginStatus, login, clear, isAuthenticated } = useInternetIdentity();
...
const DateKey = Text;
const Timestamp = Int;
const WaterEntry = Record({
  "amountMl": Nat,
  "timestamp": Timestamp
});
const DailyTrackingSummary = Record({
  "date": DateKey,
...
const FlexibilityLevel = Nat;
const FitnessTrack = Variant({
  "intermediate": Null,
  "beginner": Null,
  "advanced": Null
});
...
Service({
  "addWaterEntry": Func([Text, Nat], [], []),
  "clearLastWaterEntry": Func([Text], [], []),
  "getAllDayPlans": Func([], [Vec(DayPlan)], ["query"]),
  "getDailyTrackingSummary": Func(
    [Text],
    [DailyTrackingSummary],
    ["query"]
  ),
  "getDayPlan": Func([Nat], [Opt(DayPlan)], ["query"]),
  "getMyProfile": Func([], [Opt(UserProfile)], ["query"]),
  "getMyProgress": Func([], [UserProgress], ["query"]),
  "getStepCount": Func([Text], [DailyStepCount], ["query"]),
  "getWaterIntake": Func([Text], [DailyTrackingSummary], ["query"]),
  "hasCompletedOnboarding": Func([], [Bool], ["query"]),
  "markDayComplete": Func(
    [Nat],
    [Variant({ "ok": Text, "err": Text })],
    []
  ),
  "saveProfile": Func([ProfileInput], [UserProfile], []),
  "saveStepCount": Func([Text, Nat], [], []),
  "setDeveloperMode": Func(
    [Text],
    [Variant({ "ok": Text, "err": Text })],
    []
  )
...
const idlFactory = ({ IDL: IDL2 }) => {
  const Macros2 = IDL2.Record({
    "fatG": IDL2.Nat,
    "calories": IDL2.Nat,
    "carbsG": IDL2.Nat,
    "proteinG": IDL2.Nat
  });
  const MealType2 = IDL2.Variant({
    "breakfast": IDL2.Null,
    "lunch": IDL2.Null,
    "snack": IDL2.Null,
    "dinner": IDL2.Null
  });
  const Meal2 = IDL2.Record({
    "prepTimeMins": IDL2.Nat,
    "name": IDL2.Text,
  ...
  const Exercise2 = IDL2.Record({
    "difficulty": IDL2.Text,
    "name": IDL2.Text,
    "reps": IDL2.Nat,
    "sets": IDL2.Nat,
    "description": IDL2.Text,
    "instructions": IDL2.Text,
    "durationSec": IDL2.Nat
  });
  const DayPlan2 = IDL2.Record({
    "day": IDL2.Nat,
    "focus": IDL2.Text,
    "meals": IDL2.Vec(Meal2),
    "title": IDL2.Text,
    "exercises": IDL2.Vec(Exercise2)
  });
  const DateKey2 = IDL2.Text;
  const Timestamp2 = IDL2.Int;
  const WaterEntry2 = IDL2.Record({
    "amountMl": IDL2.Nat,
    "timestamp": Timestamp2
  });
  const DailyTrackingSummary2 = IDL2.Record({
    "date": DateKey2,
    "lastUpdated": Timestamp2,
    "waterEntries": IDL2.Vec(WaterEntry2),
    "steps": IDL2.Nat,
    "totalWaterMl": IDL2.Nat,
    "waterGoalMl": IDL2.Nat
  });
  const FlexibilityLevel2 = IDL2.Nat;
  const FitnessTrack2 = IDL2.Variant({
  ...
  const UserProfile2 = IDL2.Record({
    ...
    "heightCm": IDL2.Float64,
    "createdAt": Timestamp2,
    "email": IDL2.Text,
    "updatedAt": Timestamp2,
    "weightKg": IDL2.Float64,
    "flexibilityLevel": FlexibilityLevel2,
    "dietaryRestrictions": IDL2.Text,
    "fitnessTrack": FitnessTrack2,
    "phone": IDL2.Text,
    "healthIssues": IDL2.Text
  });
  const UserProgress2 = IDL2.Record({
    "completedDays": IDL2.Vec(IDL2.Nat),
    "principal": IDL2.Principal,
    "lastCompletedDay": IDL2.Opt(IDL2.Nat),
    "fitnessTrack": FitnessTrack2,
    "isDeveloper": IDL2.Bool
  });
  const DailyStepCount2 = IDL2.Record({
    "date": DateKey2,
    "lastUpdated": Timestamp2,
    "steps": IDL2.Nat
  });
  ...
  return IDL2.Service({
    "addWaterEntry": IDL2.Func([IDL2.Text, IDL2.Nat], [], []),
    "clearLastWaterEntry": IDL2.Func([IDL2.Text], [], []),
    "getAllDayPlans": IDL2.Func([], [IDL2.Vec(DayPlan2)], ["query"]),
    "getDailyTrackingSummary": IDL2.Func(
      [IDL2.Text],
      [DailyTrackingSummary2],
      ["query"]
    ),
    "getDayPlan": IDL2.Func([IDL2.Nat], [IDL2.Opt(DayPlan2)], ["query"]),
    "getMyProfile": IDL2.Func([], [IDL2.Opt(UserProfile2)], ["query"]),
    "getMyProgress": IDL2.Func([], [UserProgress2], ["query"]),
    "getStepCount": IDL2.Func([IDL2.Text], [DailyStepCount2], ["query"]),
    "getWaterIntake": IDL2.Func([IDL2.Text], [DailyTrackingSummary2], ["query"]),
    "hasCompletedOnboarding": IDL2.Func([], [IDL2.Bool], ["query"]),
    "markDayComplete": IDL2.Func(
      [IDL2.Nat],
      [IDL2.Variant({ "ok": IDL2.Text, "err": IDL2.Text })],
      []
    ),
    "saveProfile": IDL2.Func([ProfileInput2], [UserProfile2], []),
    "saveStepCount": IDL2.Func([IDL2.Text, IDL2.Nat], [], []),
    "setDeveloperMode": IDL2.Func(
      [IDL2.Text],
      [IDL2.Variant({ "ok": IDL2.Text, "err": IDL2.Text })],
      []
    )
...
class Backend {
  ...
  async clearLastWaterEntry(arg0) {
    if (this.processError) {
      try {
  ...
  async getDailyTrackingSummary(arg0) {
    if (this.processError) {
      try {
...
function from_candid_DayPlan_n2(_uploadFile, _downloadFile, value) {
  return from_candid_record_n3(_uploadFile, _downloadFile, value);
}
function from_candid_FitnessTrack_n13(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n14(_uploadFile, _downloadFile, value);
}
function from_candid_MealType_n7(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n8(_uploadFile, _downloadFile, value);
}
function from_candid_Meal_n5(_uploadFile, _downloadFile, value) {
  return from_candid_record_n6(_uploadFile, _downloadFile, value);
}
function from_candid_UserProfile_n11(_uploadFile, _downloadFile, value) {
  return from_candid_record_n12(_uploadFile, _downloadFile, value);
}
function from_candid_UserProgress_n15(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n8(_uploadFile, _downloadFile, value) {
  return "breakfast" in value ? "breakfast" : "lunch" in value ? "lunch" : "snack" in value ? "snack" : "dinner" in value ? "dinner" : value;
}
...
function parseProgress(raw) {
  const principalStr = typeof raw.principal === "string" ? raw.principal : typeof raw.principal.toText === "function" ? raw.principal.toText() : String(raw.principal);
...
function useMarkDayComplete() {
  const { actor } = useActor(createActor);
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (day) => {
      if (!actor) throw new Error("Actor not ready");
      const result = await actor.markDayComplete(
        BigInt(day)
      );
...
function useSetDeveloperMode() {
  const { actor } = useActor(createActor);
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (code) => {
      if (!actor) throw new Error("Actor not ready");
      const result = await actor.setDeveloperMode(
        code
      );
      if ("err" in result) throw new Error(result.err);
      return result.ok;
...
function useDerivedProgress() {
  const { data: progress2 } = useMyProgress();
  const isDeveloper = (progress2 == null ? void 0 : progress2.isDeveloper) ?? false;
  const completedDays = (progress2 == null ? void 0 : progress2.completedDays) ?? [];
  let currentDay = 1;
  for (let d = 1; d <= 30; d++) {
...
const Dumbbell = createLucideIcon("dumbbell", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: cn(
        ...
        isDeveloper ? "border-primary/40 bg-primary/8 text-primary" : "border-border bg-muted text-foreground"
      ),
      title: isDeveloper ? "Developer mode active" : `${count} days completed`,
      children: isDeveloper ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3 h-3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "DEV" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-3 h-3 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "tabular-nums", children: [
          count,
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-normal", children: "/30" })
        ] })
      ] })
    }
  );
...
function Layout({ children, hideNav = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    !hideNav && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { className: "w-5 h-5 text-primary-foreground" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-none select-none", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg tracking-tight leading-none header-brand-text", children: "FitPlan" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-[10px] font-semibold text-muted-foreground leading-none mt-0.5 tracking-widest uppercase", children: "30 Days" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-1", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                className: cn(
                  ...
                  currentPath.startsWith(link.href) ? "text-primary" : "text-muted-foreground hover:text-foreground hover:bg-muted"
                ),
                "data-ocid": `layout.nav_${link.label.toLowerCase().replace(/\s/g, "_")}_link`,
                children: [
                  currentPath.startsWith(link.href) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: "absolute inset-0 rounded-lg bg-primary/8",
                      style: {
                        boxShadow: "inset 0 0 0 1px oklch(var(--primary) / 0.2)"
                      }
                    }
                  ),
                  link.label
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-2", children: [
              isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressPill, {}),
          ...
          mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressPill, {}) }),
                navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    ...
                    className: cn(
                      ...
                      currentPath.startsWith(link.href) ? "bg-primary/10 text-primary" : "text-foreground hover:bg-muted"
                    ),
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", onClick: () => setMobileMenuOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    variant: "default",
                    size: "sm",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col", "data-ocid": "layout.main", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        className: "bg-muted/40 border-t border-border py-6 px-4",
        "data-ocid": "layout.footer",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-muted-foreground font-body", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center w-6 h-6 rounded-lg header-brand-gradient opacity-80", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { className: "w-3.5 h-3.5 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground", children: "FitPlan 30" })
          ] }),
...
function toUserProfile(raw) {
  ...
  const fitnessTrack = flexLevel <= 2 ? "beginner" : flexLevel === 3 ? "intermediate" : "advanced";
  return {
...
function useHasCompletedOnboarding() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return actor.hasCompletedOnboarding();
    },
    enabled: !!actor && !isFetching && isAuthenticated
  });
}
function useSaveProfile() {
  ...
  return useMutation({
    mutationFn: async (input) => {
      if (!actor) throw new Error("Actor not ready");
      const result = await actor.saveProfile(input);
...
export {
  ...
  X,
  Zap as Z,
  useHasCompletedOnboarding as a,
  useSaveProfile as b,
  createLucideIcon as c,
  cva as d,
  useUserProfile as e,
  useMyProgress as f,
  useDerivedProgress as g,
  useActor as h,
  useQuery as i,
  useSetDeveloperMode as j,
  createActor as k,
  useMutation as l,
  motion as m,
  useMarkDayComplete as n,
  isHTMLElement as o,
  useConstant as p,
  usePresence as q,
  useIsomorphicLayoutEffect as r,
  LayoutGroupContext as s,
  useAuth as u
};
